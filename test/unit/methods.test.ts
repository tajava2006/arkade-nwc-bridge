...
describe('SUPPORTED_METHODS', () => {
  test('is exactly the methods the bridge advertises and dispatches', () => {
    ...
    // edit as deliberate — update both sides together. make_invoice is
    // intentionally absent (receive is CLINK-noffer only).
